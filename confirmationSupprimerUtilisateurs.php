...
if (isset($_POST['btnSupprimerUtilisateurs'])) {
    ...
    $sql = "DELETE FROM `utilisateurs` WHERE `Statut`=:statut AND `Creation`<=:moisDernier;";
...
<form class="text-center" method="POST">
    <button id="btnSupprimerUtilisateurs" style="background-color: #ff6188" class="btn w-25" type="submit"
        name="btnSupprimerUtilisateurs">Supprimer</button>

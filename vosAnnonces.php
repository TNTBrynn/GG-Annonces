    ...
    <body class="ok">
        ...
        <div>
            <form method="get">
                ...
                <a href="inscriptionAnnonce.php" style="float: right; display: inline-block; padding: 10px 20px; background-color: blue; color: white; text-align: center; text-decoration: none; border-radius: 4px;">Ajouter une annonce</a>
                <div>
                    <!-- Tri par  date-->
...
?>
                <br>
                <a href="majAnnonce.php?id=<?= $item['NoAnnonce'] ?>" style="display: inline-block; padding: 5px 20px; background-color: green; color: white; text-align: center; text-decoration: none; border-radius: 4px; margin-top: 20px;">Modifier l'annonce</a>
                <a href="retirerAnnonce.php?id=<?= $item['NoAnnonce'] ?>" style="display: inline-block; padding: 5px 20px; background-color: red; color: white; text-align: center; text-decoration: none; border-radius: 4px; margin-top: 20px;">Retirer l'annonce</a>
